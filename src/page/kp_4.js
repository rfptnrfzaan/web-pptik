...
import img1 from "../assets/KP3_1.jpeg";
import img2 from "../assets/KP3_2.jpeg";
import img3 from "../assets/KP3_3.jpeg";
...
const Kp_4 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-7">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Pemasangan Alat Survey</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col max-w-4xl mx-auto">
        <p className="konten text-sm">Pemasangan Alat Survey dilakukan di Lampung pada tanggal 8 November 2022.</p>
