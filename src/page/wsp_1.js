...
import img1 from "../assets/WSP_1.jpeg";
import img2 from "../assets/WSP_2.jpeg";
import img3 from "../assets/WS_1.jpeg";
...
const WSP_1 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-7">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Workshop Penyelarasan Kurikulum Bahan Ajar SMK Wikrama</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col max-w-4xl mx-auto">
        <p className="konten text-sm">PPTIK diundang untuk menjadi pembicara pada kegiatan Workshop Penyelarasan Kurikulum Bahan Ajar SMK Wikrama. Kegiatan tersebut dilakukan pada tanggal 21 September 2022.</p>
