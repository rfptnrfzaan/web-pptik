...
import img from "../assets/K_3.jpeg";
...
const Kp_3 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Koordinasi SIM dengan SMKN 7 Kota Tangerang</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        <p className="konten text-sm">PTIK bersama SMKN 7 Kota Tangerang melakukan koordinasi terkait Website SIM (Sistem Informasi Sekolah). Koordinasi tersebut dilakukan pada tanggal 21 Desember 2022</p>
