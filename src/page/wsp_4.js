...
import img1 from "../assets/WS_4.jpeg";
...
const WSP_4 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-7">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Workshop di SMK Ulil Albab Cirebon</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col max-w-4xl mx-auto">
        <p className="konten text-sm">PPTIK bersama tim melakukan workshop. Workshop dilakukan di SMK Ulil Albab Cirebon. Workshop dilakukan pada tanggal 24 Februari 2022.</p>
