...
import img1 from "../assets/K_8.jpeg";
import img2 from "../assets/KP8_2.jpeg";
import img3 from "../assets/KP8_3.jpeg";
...
const Kp_8 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-7">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Diskusi lanjutan SEMUT JABAR</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col max-w-4xl mx-auto">
        <p className="konten text-sm">PPTIK melakukan diskusi terkait Semut Jabar. Diskusi dilakukan pada tanggal 7 Juni 2022 di Dinas Perhubungan Jawa Barat.</p>
