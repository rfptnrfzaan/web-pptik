...
import img from "../assets/R_1.jpg"
const Rp_1 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Serah Terima IoT Tracker Universitas Trilogi</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        <p className="konten text-sm">Diskusi dan serah terima IoT Tracker dari PPTIK ITB ke Universitas Trilogi.</p>
