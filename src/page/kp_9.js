...
import img from "../assets/K_9.jpeg"
const Kp_9 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Penyerahan Alat Peraga Smart Hidroponik</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        
        <p className="konten text-sm">Alat Peraga Smart Hidroponik adalah salah satu produk yang dikembangkan oleh PPTIK. Pada tanggal 24 Mei 2022 PPTIK melakukan penyerahan Alat Peraga tersebut ke SMK Riyadul Hikmah.</p>
