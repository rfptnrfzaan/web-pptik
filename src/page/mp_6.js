...
import img from "../assets/M_6.jpeg"
const Mp_6 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Diskusi Lampung Digital Heritage antara UBL, PPTIK ITB dan Pemda Lampung Timur</h1>
