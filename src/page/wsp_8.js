...
import img1 from "../assets/WS_8.jpeg";
...
const WSP_8 = () => {
    return ( 
        ...
        <div className="flex flex-col mb-7">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Sosialisasi Kawal Desa</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col max-w-4xl mx-auto">
        <p className="konten text-sm">Kawal Desa ialah salah satu aplikasi yang dikembangkan PPTIK. PPTIK melakukan sosialisasi aplikasi kawal desa pada tanggal 3 Juli 2021.</p>
