...
import img from "../assets/R_4.jpeg"
const Rp_4 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Kerjasama Riset STT YBS Internasional</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        <p className="konten text-sm">Penandatanganan surat kerjasama antara PPTIK ITB dan STT YBS Internasional.</p>
