...
import img from "../assets/K_5.jpeg";
const Kp_5 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Diskusi Project Legit Bandung</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        
        <p className="konten text-sm">Tim PPTIK dan teman teman dari TMDG melakukan diskusi terkait project legit bandung dan survey gedung. Diskusi dilakukan pada tanggal 13 Oktober 2022.</p>
