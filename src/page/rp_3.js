...
import img from "../assets/R_3.jpg"
const Rp_3 = () => {
    return ( 
        <>
        <Navbar/>
        <div className="flex flex-col mb-5">
            <h1 className="pt-5 ml-10 text-2xl pb-2 head">Diskusi PPTI 2018 bersama Ristekdikti</h1>
            <span className="ml-10 w-40 border-b-2 border-black "></span>
        </div>
        <div className="flex flex-col  max-w-4xl mx-auto">
        <p className="konten text-sm">Diskusi bersama Dr.Ir.Hendro Wicaksono, Kasubdit pengembangan teknologi industri. Membahas mengenai proposal dikti skim Program Pengembangan Teknologi Industri (PPTI) 2018.</p>
